...
<TR>
<!-- Row 1 -->
<TD align=left colspan=4 style="background: #c4af6b;height: 30px;padding-left:10px"> <span style="font-size:22px;color: #fff;text-shadow: 1px 1px 2px rgba(73,73,73,0.61);"><strong>  Cash a cheque</strong></span></TD>
</TR>
<TR>
<!-- Row 2 -->
...
<td style="padding-left:10px;width:200px;">
       <form action = "Insert_Cheque_Receiver.php" method = "POST">

		<h2>Cheque Detail:</h2>

        <p>
        <label>ChequeID:</label>
		<input type="text" name="ChequeID" placeholder="7 digits number" pattern="[0-9]{7}" oninvalid="alert('Please Enter a valid ChequeID')" required>
	    </p>
        ...
        <p> 
			...
			<table><tbody>
<tr> <td>Status:</td>
<td style="padding-left: 5px"><label class="container">Accept
 <input type="radio" name="Status" value="1" checked required>
  <span class="checkmark"></span>
</label></td>
<td style="padding-left: 5px"><label class="container">Reject
  ...
  <span class="checkmark"></span>
		...
		<input type="datetime-local" name="WrittenDate"  required><br>
	    </p>

	    <p>
		<label>Cheque Date:</label>
		<input type="datetime-local" name="ChequeDate"  required><br>
	    </p>
<table><tbody>
...
<td>
        ...
        <h2>Receiver Information:</h2>
            ...
            <input type="text" name="fName" pattern="[a-zA-Z]+" oninvalid="alert('Please enter a valid FirstName (only characters)')" required> </p>
        ...
        <p>
            ...
            <input type="text" name="Zipcode" pattern="[0-9]{5}" placeholder="5 digits number" oninvalid="alert('Please enter a valid Zipcode (only 5-digits)')" required>
        </p>
