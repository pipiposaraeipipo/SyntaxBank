...
<TR>
<!-- Row 1 -->
<TD align=left colspan=4 style="background: #c4af6b;height: 30px;padding-left:10px"> <span style="font-size:22px;color: #fff;text-shadow: 1px 1px 2px rgba(73,73,73,0.61);"><strong>  Deposit / Withdraw</strong></span></TD>
</TR>
<TR>
<!-- Row 2 -->

<td style="padding-left:20px;padding-right: 20px; width:200px;">
      <form action = "Insert_DepositWithDraw.php" method = "POST">
            <h2> Deposit/Withdraw </h2>
		  <table><tbody>
<tr> <td>Type:</td>
<td style="padding-left: 5px"><label class="container">Deposit
 <input type="radio" name="Type" value="Deposit" checked required>
  <span class="checkmark"></span>
</label></td>
<td style="padding-left: 5px"><label class="container">Withdraw
  <input type="radio" name="Type" value="Withdraw" checked required>
  <span class="checkmark"></span>
</label></td></tr>
</tbody></table>
            ...
            <p>
		        <label>Amount:</label>
		        <input type="number" name="Amount" id="amount" placeholder="500" step="1" min="0" oninvalid="alert('Please enter a valid Amount')" required> THB<br>
	        </p>
            ...
            <p>
		        <label>Fee:</label>
		        <input type="number" name="Fee" placeholder="1.00" step="0.01" min="0" oninvalid="alert('Please enter a valid Fee')" required> THB<br>
            </p>
