...
<html>
   <head>
		<title>Transfer and Payment</title>
        ...
        <script>
        				...
        				$(document).ready(function()
			{
    			$('#customer').on('change', function()
    			{
        			...
        			{
            			$('#card').html('<option value="">Select CustomerID First</option>');
        			}
    			});
    		});	  
        </script>
...
<TR>
<!-- Row 1 -->
<TD align=left colspan=4 style="background: #c4af6b;height: 30px;padding-left:10px"> <span style="font-size:22px;color: #fff;text-shadow: 1px 1px 2px rgba(73,73,73,ผ0.61);"><strong>  Transfer / Payment</strong></span></TD>
</TR>
<TR>
<!-- Row 2 -->
...
<td style="padding-left:10px;width: 300px">
        <form action = "Insert_TransferPayment_Orga.php" method = "POST">

		<h2>Transfer/Payment:</h2>
        <p> 
  <table><tbody>
<tr> <td>Type:</td>
<td style="padding-left: 5px"><label class="container">Transfer
 <input type="radio" name="TransPType" value="Transfer" checked required>
  <span class="checkmark"></span>
</label></td>
<td style="padding-left: 5px"><label class="container">Payment
  <input type="radio" name="TransPType" value="Payment" checked required>
  <span class="checkmark"></span>
</label></td></tr>
</tbody></table>	
        </p>
        ...
        <p>
		<label>Amount:</label>
		<input type="number" id="amount" name="Amount" placeholder="1.00" step="0.01" min="0" oninvalid="alert('Please enter a valid Amount')" required>&nbsp;THB<br>
	    </p>
        ...
        <p>
            ...
            <input type="number" name="Fee" placeholder="1.00" step="0.01" min="0" oninvalid="alert('Please enter a valid Fee')" required> 
        </p>
        ...
        <?php
            ...
            echo "StaffID:<select name='StaffID'>";
            while( $row = mysqli_fetch_array($res) )
            {
                 echo "<option value= '".$row['StaffID']."'> ".$row['StaffID']." ".'-'." ".$row['fName']." ".$row['lName']." </option>";
            }
            echo "</select>"
        ?> <br>	
  ...
  <table><tbody>
				 <tr>Do you want to use Credit Card?</tr>
<tr> 
...
<td style="padding-left: 5px"><label class="container">No
  ...
  <span class="checkmark"></span>
        ...
        <p>
        Ref1
        <input type="text" name="Ref1"  oninvalid="alert('Please enter a valid Ref1')" required>
        </p>

        <p>
        Ref2
        <input type="text" name="Ref2"  oninvalid="alert('Please enter a valid Ref2')" required>
        </p>
...
<td style="padding-right: :20px;">
        ...
        <input type="text" name="orgaName"  oninvalid="alert('Please enter organization name')" required>
        </p>

        <p>
        <label for="Type">Type:</label>
        <input type="text" name="type"  oninvalid="alert('Please enter type')" required>
        </p>

         <p>
            <label for="Account No">Account No:</label>
            <input type="text" name="accNo" pattern="[0-9]{10}"  placeholder="10 digits number" oninvalid="alert('Please enter a valid account No (only 10-digits)')" required>
        </p>

         <p>
            <label for="SwiftCode">SwiftCode:</label>
            <input type="text" name="swCode" pattern="[a-zA-Z0-9-]{10}"  placeholder="10 digits char/num" oninvalid="alert('Please enter a valid SwiftCode (only 10-digits)')" required>
        </p>  
